---
title: DevOps -- CDN update automation
---

> CDN可以通过提供的API进行刷新目录等动作。
...
当你需要刷新目录时，类似以下用法：
```
python ./QcloudCdnTools_V2.py RefreshCdnDir -u $YOUR_USER -p $YOUR_PASS --dirs="http://www.pano.video/download/"
```
